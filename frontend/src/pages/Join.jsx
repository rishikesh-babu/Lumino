  ...
  return (
    <div className="min-h-screen flex flex-col items-center p-6">
      <div className="shadow-lg rounded-lg p-8 max-w-2xl w-full">
        <h2 className="text-3xl font-bold text-center">Join Code Storm</h2>
        ...
        <div className="mt-6 space-y-4">
          {jobs.map((job) => (
            <div key={job.id} className="border p-4 rounded-lg">
              ...
              <button onClick={() => handleApply(job)} className="mt-3 bg-blue-600 px-4 py-2 rounded hover:bg-blue-700">Apply</button>
            </div>
          ))}
        </div>
      </div>
