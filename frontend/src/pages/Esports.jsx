  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center p-6">
      ...
      <div className="mt-12 text-center">
        ...
        <p className="text-lg text-gray-300 mt-3">Be part of the next big wave in esports. Compete. Stream. Succeed.</p>
        <button className="mt-6 px-6 py-3 bg-blue-500 hover:bg-blue-600 rounded-full text-white font-semibold transition-all">
          Get Started
        </button>
      </div>
    </div>
