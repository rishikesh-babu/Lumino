  ...
  return (
    <div className="bg-gray-100 text-gray-900">
      ...
      <div className="relative h-[350px] bg-cover bg-center flex items-center justify-center text-center" 
        ...
        <h1 className="relative text-4xl md:text-5xl font-bold text-white">Our Services</h1>
      </div>
      ...
      <div className="bg-blue-600 text-white text-center py-10 mt-16">
        ...
        <button className="mt-4 px-6 py-3 bg-white text-blue-600 font-semibold rounded-lg hover:bg-gray-200 transition duration-300">
          Get in Touch
        </button>
      </div>
    </div>
